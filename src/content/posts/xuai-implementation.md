---
title: "给博客装了个AI脑子 —— XUUAI 实现方案全记录"
published: 2026-05-30 22:00:00
...
本博客目前集成了两套 AI 功能：**XUUAI 问答**（悬浮在文章页面的 AI 聊天面板）和**文章概括**（每篇文章顶部的 AI 摘要卡片）。本文从技术栈、架构设计、实现细节、踩坑记录四个维度完整介绍其实现方案。
